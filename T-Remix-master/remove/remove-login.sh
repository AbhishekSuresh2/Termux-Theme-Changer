...
tput cup 6 30
echo -e "\x1b[42mComedy Melody CH \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have You Subscribe My YouTube Channel Comedy Melody CH (y/n)? \e[m "
read answer
...
tput cup 17 23
    echo -e "\x1b[41m Please Subsrcibe My YouTube Channel \x1b[m"
fi
tput cup 20 0
